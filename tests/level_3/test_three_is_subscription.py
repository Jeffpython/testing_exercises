...
def test__is_subscription__is_not_subscription_if_same_destination_expenses_less_than_3(make_expense, make_expenses):
...
def test__is_subscription__is_not_subscription_if_expenses_amount_for_month_greater_than_1(make_expense, make_expenses):
    expense = make_expense(spent_in='Магнит')
    history = make_expenses(count=2, spent_in='Магнит',  spent_at=datetime.datetime(2024,1,10))
    assert is_subscription(expense, history) is False

def test__is_subscription__is_subscription_if_same_destination_expenses_equals_3_and_month_to_expenses_amount_equal_1(make_expense):
    expense = make_expense(spent_in='Магнит')
    history = [
...
def test__is_subscription__is_subscription_if_same_destination_expenses_greater_than_3_and_month_to_expenses_amount_equal_1(make_expense):
    expense = make_expense(spent_in='Магнит')
    history = [
        make_expense(spent_in='Магнит', spent_at=datetime.datetime(2024,1,10)),
        make_expense(spent_in='Магнит', spent_at=datetime.datetime(2024,2,10)),
